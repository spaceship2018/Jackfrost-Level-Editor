...
You can fire up the game in ruffle in firefox browser load the swf from the official link and override the url loading of the level xml files to your harddisk via webdevelopers network tab
